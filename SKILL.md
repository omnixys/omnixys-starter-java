<!-- repository: packages/java/starter | kind: PACKAGE | stack: java-maven -->

# starter — Skill: Package Development

> Workflow for starter (packages/java/starter). Execute this workflow before, during, and
> after changes in this repository.

## Repository Facts

- Kind: Shared Package
- Package: `com.omnixys:starter` (version: 1.0.4)
- Runtime: Java 26 (Maven)
- Description: Omnixys Platform Starter.
- Architecture: target/ only — no source currently checked in
...
- This package is published (`com.omnixys:starter`); consumers pin versions and rely on SemVer.
