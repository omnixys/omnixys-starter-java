...
> Repository development instructions for **starter** (Shared Package).
> Stack: java-maven. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys Platform Starter.

- Repository path: `packages/java/starter` (relative to the Omnixys root)
...
target/ only — no source currently checked in
...
No source present; verify before modifying. May require manual attention.
